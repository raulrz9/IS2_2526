...
/*
 * Metricas iniciales:
 * WMC = 22. main = 21 (while + switch + cases + if/else +
 * bucles y decisiones internas); mensaje = 1.
 * WMCn = 11.00 (22 / 2 metodos)
 * CCog = 32. La mayor parte procede del bucle principal, el switch
 * de menu, los if/else y el bucle de seleccion del mejor conductor.
 * CCogn = 16.00 (32 / 2 metodos)
 * CBO = 10 (LinkedList, List, Menu, Lectura, Mensaje, String,
